...
const PaddyHamaliEntry = sequelize.define('PaddyHamaliEntry', {
  id: {
  ...
  underscored: true,
  indexes: [
    { fields: ['arrival_id'], name: 'idx_paddy_hamali_entries_arrival' },
    { fields: ['status'], name: 'idx_paddy_hamali_entries_status' },
    { fields: ['added_by'], name: 'idx_paddy_hamali_entries_added_by' }
  ]
});
